...
const TransactionDetails: React.FC<TransactionDetailsProps> = ({
  ...
  // Toggle portfolio flag
  const handleTogglePortfolioFlag = async () => {
  ...
  const handleDelete = async () => {
    ...
    const confirmed = window.confirm(
      ...
      `Date: ${TransactionService.formatDate(transaction.txn_date)}\n` +
      `Amount: ${TransactionService.formatAmount(transaction.total_amount)}\n\n` +
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{
                ...
                <button
                  onClick={handleTogglePortfolioFlag}
                  style={{
                    padding: '8px 16px',
