...
export const mockPortfolioData: Record<number, PortfolioData> = {
  1: {
    ...
    monthlyPerformance: [
      { month: 'Jan', value: 2400000, returns: 8.2 },
      { month: 'Feb', value: 2450000, returns: 9.1 },
      { month: 'Mar', value: 2425000, returns: 7.8 },
      { month: 'Apr', value: 2525000, returns: 10.5 },
      { month: 'May', value: 2592000, returns: 11.8 },
      { month: 'Jun', value: 2568000, returns: 10.7 },
      { month: 'Jul', value: 2688000, returns: 12.4 },
      { month: 'Aug', value: 2760000, returns: 13.2 },
      { month: 'Sep', value: 2712000, returns: 12.1 },
      { month: 'Oct', value: 2856000, returns: 13.8 },
      { month: 'Nov', value: 2928000, returns: 14.1 },
      { month: 'Dec', value: 2847500, returns: 13.9 }
    ],
    recentTransactions: [
      { date: '2024-12-10', type: 'SIP', amount: 25000, fundName: 'HDFC Top 100 Fund', units: 45.2, nav: 552.88 },
      { date: '2024-12-01', type: 'BUY', amount: 100000, fundName: 'ICICI Pru Corporate Bond', units: 3245.8, nav: 30.82 },
      { date: '2024-11-28', type: 'SWITCH', amount: 50000, fundName: 'From: Axis Liquid To: Axis Bluechip', units: 0, nav: 0 },
      { date: '2024-11-10', type: 'SIP', amount: 25000, fundName: 'HDFC Top 100 Fund', units: 46.1, nav: 542.30 },
      { date: '2024-11-05', type: 'SELL', amount: 75000, fundName: 'SBI Small Cap', units: 450, nav: 166.67 },
      { date: '2024-10-10', type: 'SIP', amount: 25000, fundName: 'HDFC Top 100 Fund', units: 47.8, nav: 523.01 }
    ],
    sipDetails: [
      { fundName: 'HDFC Top 100 Fund', amount: 25000, date: 10, active: true, startDate: '2020-03-10', totalInvested: 1175000 },
      { fundName: 'SBI Balanced Advantage', amount: 15000, date: 15, active: true, startDate: '2021-06-15', totalInvested: 630000 },
      { fundName: 'Axis Bluechip Fund', amount: 20000, date: 5, active: false, startDate: '2019-08-05', totalInvested: 520000 }
    ]
  },
  2: {
    customerId: 2,
...
// Export PortfolioData type for convenience
