...
-- ============================================================================
-- PART 2: UPDATE RPC FUNCTION
-- Key change: sd.asset_type_id → sd.scheme_category_id (line ~1345)
-- ============================================================================
        ...
        BEGIN
            ...
            IF v_staging_record.mapped_data->>'scheme_name' IS NOT NULL AND
               TRIM(v_staging_record.mapped_data->>'scheme_name') != '' THEN
                ...
                -- ============================================================
                -- v1.3 FIX: LOOKUP ASSET TYPE using scheme_category_id
                -- Changed from: sd.asset_type_id
                -- Changed to:   sd.scheme_category_id
                -- ============================================================
