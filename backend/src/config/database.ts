...
export const pool = new Pool({
  ...
  idleTimeoutMillis: 300000,     // 5 minutes - how long a client can be idle before being removed
  connectionTimeoutMillis: 20000, // 20 seconds - how long to wait for a connection
