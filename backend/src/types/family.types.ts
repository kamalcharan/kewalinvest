// backend/src/types/family.types.ts
...
export interface FamilyMemberPortfolio {
  ...
  scheme_count: number;
  portfolio_percentage: number; // % of total family portfolio
}
...
export interface GetFamilyPortfolioResponse {
  success: boolean;
  data?: FamilyPortfolioSummary;
  error?: string;
}

export interface GetFamilyAssetAllocationResponse {
  success: boolean;
  data?: FamilyAssetAllocation;
  error?: string;
}

export interface GetFamilyGoalSummaryResponse {
  success: boolean;
  data?: FamilyGoalSummary;
  error?: string;
}

export interface GetFamilyMeetingSummaryResponse {
  success: boolean;
  data?: FamilyMeetingSummary;
  error?: string;
}
